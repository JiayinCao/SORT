...
SORT features a node graph based material system so that it is quite flexible in what it can render.
Following is an screenshot of SORT working in Blender with a flexiable material node system design.
