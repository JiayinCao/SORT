...
//! @brief Square class defines the basic behavior of square.
/**
 * The square center is always at the origin of its local coordinate, the normal of the square points exactly
 * upward in its local coordinate. Square is special rectangle where sizeX equals to sizeY.
 */
