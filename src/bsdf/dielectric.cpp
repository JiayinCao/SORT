...
Bxdf(weight, (BXDF_TYPE)(BXDF_DIFFUSE | BXDF_REFLECTION), params.n, true), R(params.reflectance), T(params.transmittance), fresnel(1.0f,1.5f), 
        mf_reflect(params.reflectance, &fresnel, SORT_MALLOC(GGX)(params.roughnessU, params.roughnessV), FULL_WEIGHT, DIR_UP, true),
        mf_refract(params.transmittance, SORT_MALLOC(GGX)(params.roughnessU, params.roughnessV), 1.0f, 1.5f, FULL_WEIGHT, DIR_UP){
}
