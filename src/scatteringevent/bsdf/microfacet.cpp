...
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMirror, Tsl_float3, normal)
IMPLEMENT_CLOSURE_TYPE_END(ClosureTypeMirror)

IMPLEMENT_CLOSURE_TYPE_BEGIN(ClosureTypeMicrofacetReflectionGGX)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionGGX, Tsl_float3, interior_ior)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionGGX, Tsl_float3, absorption_co)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionGGX, Tsl_float, roughness_u)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionGGX, Tsl_float, roughness_v)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionGGX, Tsl_float3, base_color)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionGGX, Tsl_float3, normal)
IMPLEMENT_CLOSURE_TYPE_END(ClosureTypeMicrofacetReflectionGGX)

IMPLEMENT_CLOSURE_TYPE_BEGIN(ClosureTypeMicrofacetReflectionBlinn)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBlinn, Tsl_float3, interior_ior)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBlinn, Tsl_float3, absorption_co)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBlinn, Tsl_float, roughness_u)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBlinn, Tsl_float, roughness_v)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBlinn, Tsl_float3, base_color)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBlinn, Tsl_float3, normal)
IMPLEMENT_CLOSURE_TYPE_END(ClosureTypeMicrofacetReflectionBlinn)

IMPLEMENT_CLOSURE_TYPE_BEGIN(ClosureTypeMicrofacetReflectionBeckmann)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBeckmann, Tsl_float3, interior_ior)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBeckmann, Tsl_float3, absorption_co)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBeckmann, Tsl_float, roughness_u)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBeckmann, Tsl_float, roughness_v)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBeckmann, Tsl_float3, base_color)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionBeckmann, Tsl_float3, normal)
IMPLEMENT_CLOSURE_TYPE_END(ClosureTypeMicrofacetReflectionBeckmann)

IMPLEMENT_CLOSURE_TYPE_BEGIN(ClosureTypeMicrofacetReflectionDielectric)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionDielectric, Tsl_float3, iorI)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionDielectric, Tsl_float3, iorT)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionDielectric, Tsl_float, roughness_u)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionDielectric, Tsl_float, roughness_v)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionDielectric, Tsl_float3, base_color)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetReflectionDielectric, Tsl_float3, normal)
IMPLEMENT_CLOSURE_TYPE_END(ClosureTypeMicrofacetReflectionDielectric)

IMPLEMENT_CLOSURE_TYPE_BEGIN(ClosureTypeMicrofacetRefractionGGX)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionGGX, Tsl_float, etaI)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionGGX, Tsl_float, etaT)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionGGX, Tsl_float, roughness_u)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionGGX, Tsl_float, roughness_v)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionGGX, Tsl_float3, transmittance)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionGGX, Tsl_float3, normal)
IMPLEMENT_CLOSURE_TYPE_END(ClosureTypeMicrofacetRefractionGGX)

IMPLEMENT_CLOSURE_TYPE_BEGIN(ClosureTypeMicrofacetRefractionBlinn)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBlinn, Tsl_float, etaI)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBlinn, Tsl_float, etaT)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBlinn, Tsl_float, roughness_u)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBlinn, Tsl_float, roughness_v)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBlinn, Tsl_float3, transmittance)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBlinn, Tsl_float3, normal)
IMPLEMENT_CLOSURE_TYPE_END(ClosureTypeMicrofacetRefractionBlinn)

IMPLEMENT_CLOSURE_TYPE_BEGIN(ClosureTypeMicrofacetRefractionBeckmann)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBeckmann, Tsl_float, etaI)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBeckmann, Tsl_float, etaT)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBeckmann, Tsl_float, roughness_u)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBeckmann, Tsl_float, roughness_v)
IMPLEMENT_CLOSURE_TYPE_VAR(ClosureTypeMicrofacetRefractionBeckmann, Tsl_float3, transmittance)
...
Microfacet::Microfacet(RenderContext& rc, const MF_Dist_Type distType, float ru , float rv , const Spectrum& w, const BXDF_TYPE t , const Vector& n , bool doubleSided ) :
    ...
    if(distType == MF_DIST_GGX)
        distribution = SORT_MALLOC(rc.m_memory_arena, GGX)( ru , rv );
    else if(distType == MF_DIST_BECKMANN)
        distribution = SORT_MALLOC(rc.m_memory_arena, Beckmann)( ru , rv );
    else if(distType == MF_DIST_BLINN)
        distribution = SORT_MALLOC(rc.m_memory_arena, Blinn)( ru , rv );
}
...
MicroFacetReflection::MicroFacetReflection(RenderContext& rc, const ClosureTypeMicrofacetReflectionGGX& params, const Spectrum& weight, bool doubleSided):
    ...
    R(params.base_color), fresnel(SORT_MALLOC(rc.m_memory_arena, FresnelConductor)(params.eta, params.absorption)) {
}
...
MicroFacetReflection::MicroFacetReflection(RenderContext& rc, const ClosureTypeMicrofacetReflectionDielectric& params, const Spectrum& weight, bool doubleSided) :
     Microfacet(rc, MF_DIST_GGX, params.roughness_u, params.roughness_v, weight, (BXDF_TYPE)(BXDF_DIFFUSE | BXDF_REFLECTION), params.normal, false),
     R(params.base_color), fresnel(SORT_MALLOC(rc.m_memory_arena, FresnelDielectric)(params.iorI, params.iorT)) {
}
...
MicroFacetReflection::MicroFacetReflection(RenderContext& rc, const ClosureTypeMirror& params, const Spectrum& weight, bool doubleSided ):
    Microfacet(rc, MF_DIST_GGX, 0.0f, 0.0f, weight, (BXDF_TYPE)(BXDF_DIFFUSE | BXDF_REFLECTION), params.normal, false), R(params.base_color), fresnel(SORT_MALLOC(rc.m_memory_arena, FresnelNo)()) {
}
