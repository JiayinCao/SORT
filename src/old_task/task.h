...
// I am refactoring the task system in my renderer.
// The new system will be more flexible than this one and this system will be totally deprecated.
// Wrapping it with a name space so that there won't be duplicated class names.
namespace old_task {
